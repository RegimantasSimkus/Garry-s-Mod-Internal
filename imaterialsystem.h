...
struct MaterialVideoMode_t
{
	...
	void* m_Format;	// use ImageFormats (ignored for windowed mode)
...
public:
	...
	virtual void				SetLight(int lightNum, const void*& desc) = 0;

	// The faces of the cube are specified in the same order as cubemap textures
	virtual void				SetAmbientLightCube(void* cube[6]) = 0;
	...
	virtual void** CreateStaticMesh(VertexFormat_t fmt, const char* pTextureBudgetGroup, void* pMaterial = NULL) = 0;
	...
	virtual void** GetDynamicMesh(
		bool buffered = true,
		void** pVertexOverride = 0,
		void** pIndexOverride = 0,
		void** pAutoBind = 0) = 0;
	...
	virtual void** CreateStaticVertexBuffer(VertexFormat_t fmt, int nVertexCount, const char* pTextureBudgetGroup) = 0;
	virtual void** CreateStaticIndexBuffer(MaterialIndexFormat_t fmt, int nIndexCount, const char* pTextureBudgetGroup) = 0;
	virtual void DestroyVertexBuffer(void**) = 0;
	virtual void DestroyIndexBuffer(void**) = 0;
	// Do we need to specify the stream here in the case of locking multiple dynamic VBs on different streams?
	virtual void** GetDynamicVertexBuffer(int streamID, VertexFormat_t vertexFormat, bool bBuffered = true) = 0;
	virtual void** GetDynamicIndexBuffer(MaterialIndexFormat_t fmt, bool bBuffered = true) = 0;
	virtual void BindVertexBuffer(int streamID, void** pVertexBuffer, int nOffsetInBytes, int nFirstVertex, int nVertexCount, VertexFormat_t fmt, int nRepetitions = 1) = 0;
	...
	virtual void* CreateMorph(MorphFormat_t format, const char* pDebugName) = 0;
	...
	virtual void ReadPixelsAndStretch(void* pSrcRect, void* pDstRect, unsigned char* pBuffer, void* dstFormat, int nDstStride) = 0;
	...
	virtual bool				GetMorphAccumulatorTexCoord(void** pTexCoord, void** pMorph, int nVertex) = 0;

	// Version of get dynamic mesh that specifies a specific vertex format
	virtual void** GetDynamicMeshEx(VertexFormat_t vertexFormat, bool bBuffered = true,
		void** pVertexOverride = 0, void** pIndexOverride = 0, void** pAutoBind = 0) = 0;
	...
	virtual void** GetCurrentMaterial() = 0;
...
public:
	...
	virtual void* GetShadowDepthTextureFormat() = 0;
	...
	virtual void* GetNullTextureFormat() = 0;
