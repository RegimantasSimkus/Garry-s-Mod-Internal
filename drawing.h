...
public:
	...
	void DrawTextA(const char* text, const ImVec2& pos, ImColor col, TextAlign alignx = TEXT_ALIGN_LEFT, TextAlign aligny = TEXT_ALIGN_TOP);
	void DrawTextScreenA(const char* text, const Vector& pos, ImColor col, TextAlign alignx = TEXT_ALIGN_LEFT, TextAlign aligny = TEXT_ALIGN_TOP);
};